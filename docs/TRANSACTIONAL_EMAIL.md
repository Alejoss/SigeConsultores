...
El Panel de Administración incluye dos comprobaciones limitadas a administradores. **Probar a esteban@isge360.com** remite un único mensaje exclusivamente a esa identidad verificada, para comprobar el servicio mientras Amazon SES permanezca en sandbox; la dirección está fijada en el servidor y el navegador no permite sustituirla. **Probar correo administrativo** dirige un mensaje al correo de la cuenta administrativa que ejecuta la acción y debe usarse después de que SES tenga acceso de producción o cuando ese correo también esté verificado. Ninguna prueba crea invitaciones, genera enlaces de recuperación ni modifica contraseñas. La pantalla informa éxito únicamente si Amazon SES acepta el envío; si SES no lo confirma, muestra el fallo para revisar la configuración de producción.
